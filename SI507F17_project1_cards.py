...
def show_song(inp="Winner"):
    ...
    # correctly, which it does not
    # (put in description and remove this clarity)
    songs_resp = helper_functions.get_and_cache_songs(random.choice(
        ["win", "winner", "hurrah", "hooray"]))
...
# "https://itunes.apple.com/us/album/bears-adventure/
# id495954957?i=495955054&uo=4"
# doesn’t understand the “open location” message. (-1708)
# That's an Apple-related error but will not cause
# you a problem. Don't worry about it.
